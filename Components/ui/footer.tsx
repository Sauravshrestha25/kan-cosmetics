...
export function Footer({
  ...
  return (
    <footer className="pb-6 pt-16 mb-20 lg:pb-8 lg:pt-24 text-white font-saolDisplay">
      <div className="px-2">
        ...
        <div className="border-t mt-6 pt-6 md:mt-4 md:pt-8 lg:grid lg:grid-cols-10 gap-4">
          ...
          <div className="mt-6 text-md tracking-widest leading-6  whitespace-nowrap lg:mt-0 lg:row-[1/3] lg:col-[1/4]">
