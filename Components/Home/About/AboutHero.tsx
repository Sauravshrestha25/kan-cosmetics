...
const AboutHero = () => {
  useGSAP(() => {
  gsap.from(".photo-1, .photo-2, .photo-3", {
    scrollTrigger: {
      trigger: "#about",
      start: "top 80%",
  ...
  return (
    <section id="about" className="relative min-h-screen  overflow-hidden">
      ...
      <div className="flex flex-col mx-auto ">
        <div className="photo-1 hidden md:flex justify-center lg:justify-start mb-10 lg:-mb-10 z-20">
          <AboutPhotocard
        ...
        <div className="photo-2 grid grid-cols-1 lg:grid-cols-12  items-center">
          ...
          <div className="flex flex-col items-center lg:items-center lg:col-span-8 text-center">
            ...
            <h1 className="text-4xl sm:text-6xl lg:text-8xl leading-[1.1] md:leading-[0.9] text-white font-medium">
          ...
          <div className=" photo-3 hidden lg:flex lg:col-span-2 justify-end self-center">
            <AboutPhotocard
